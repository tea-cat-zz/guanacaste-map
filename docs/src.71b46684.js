...
exports.default = function (allLayers) {
  return '<div>\n\t    <h4 class="overlay-box">Puestos Estaci\xF3nes y Tourismos</h4>\n\t\t\t<div id="legend-items" class="overlay-box">\n          ' + allLayers.map(function (layer) {
    return '<div class="legend-item active" id="' + layer.name + '" onClick="handleFilter(\'' + layer.name + '\', \'' + (layer.type || 'symbol') + '\', ' + (layer.layerId ? '\'' + layer.layerId + '\'' : null) + ')">\n                  <span class="legend-key" style="background-color: ' + layer.color + '"></span>\n                  <span class="label">' + layer.label + '</span>\n                </div>';
...
var SOURCE_TYPES = _config2.default.SOURCE_TYPES;
var getVisibleLayers = exports.getVisibleLayers = function getVisibleLayers(layerList) {
  return layerList.filter(function (_ref) {
    ...
    if (layer.id === 'toggle-turismo') {
      result[layer.id] = SOURCE_TYPES.filter(function (_ref2) {
...
},{"./config":11}],27:[function(require,module,exports) {
var bundleURL = null;
...
},{"./../svg/park-11.svg":[["park-11.2b9fa686.svg",19],19],"_css_loader":20}],6:[function(require,module,exports) {
'use strict';
...
map.on('load', function () {
  ...
  window.noFilter = function () {
    ...
    visibleLayers = (0, _utils.getVisibleLayers)(map.getStyle().layers);
    var legend = document.getElementById('legend');
    // This is where we combine the symbol layer SOURCE_TYPES with filteredLayers
    legend.innerHTML = (0, _legend2.default)([].concat(_toConsumableArray(SOURCE_TYPES), _toConsumableArray(filteredLayers)));
  };
...
},{"./config":11,"./components/popup":13,"./components/legend":14,"./utils":41,"../assets/styles/index.scss":19}],12:[function(require,module,exports) {
