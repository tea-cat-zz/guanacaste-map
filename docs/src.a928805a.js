...
var getLayerToggleHandler = exports.getLayerToggleHandler = function getLayerToggleHandler(map) {
  return function (layerId) {
    ...
    console.log({ combineWithLayers: combineWithLayers });
...
function getMap() {
  ...
  var popup = new mapboxgl.Popup({ keepInView: true, maxWidth: "240px" });
  ...
  Object.entries(_config.LAYERS).filter(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        layerConfig = _ref2[1];
